...
fit{w}.circleNonlinearRadius = [1 0 -0.0012 0 0 0 -2.3211e-8]  % newradius =radius*(1+a*x+b*x^2+....)
fit{w}.circleNonlinearSensitivity= [0 0.0208 4.1824e-4] % offset - position*(0+a*x+b*x^2+....) %%mm
