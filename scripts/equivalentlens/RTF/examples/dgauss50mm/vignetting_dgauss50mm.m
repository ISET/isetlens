...
if(not(flag_runraytrace))
 ...
 positions =[0    1.0000    2.0000    3.0000    4.0000    5.0000    6.0000    7.0000    8.0000    9.0000   10.0000   10.1000   10.2000 10.3000   10.4000   10.5000];
    ...
    for p=1:numel(positions)
        p
        maxTheta1=abs(atand(firstEle.apertureD-positions(p)  / offset_inputplane));
        maxTheta2=abs(atand(-firstEle.apertureD-positions(p)  / offset_inputplane));
        maxTheta=max(maxTheta1,maxTheta2);
        maxTheta=60
        nbPhis=nbThetas;
