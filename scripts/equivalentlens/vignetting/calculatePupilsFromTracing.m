...
if(not(flag_runraytrace))
    ...
    close all;
    save(['./cache/' lensFileName '-' datestr(now,'mmmm-dd-yyyy_HH-MMAM') '.mat'])
end
...
for p=1:numel(positions)
    ...
    viscircles([0 offset_entrance],radius_entrance,'color','k','linestyle',':')
...
for p=1:numel(positions)    
    ...
    viscircles([0 dentrance],projected_radius,'color','k')
